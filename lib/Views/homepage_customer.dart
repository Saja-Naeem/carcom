...
class _HomePageCustomerState extends State<HomepageCustomer>{
   ...
   List brands=[
   {
     "iconname": Icons.car_rental,"title":"BMW",
   },
   {
     "iconname": Icons.car_rental,"title":"Toyota",
   },
   {
     "iconname": Icons.car_rental,"title":"Mercedes",
   },
   {
     "iconname": Icons.car_rental,"title":"Tesla",
   },
   {
     "iconname": Icons.car_rental,"title":"BMW",
   },
...
(children:[
  ...
  child:Stack( children:<Widget>[
    ...
    child:const Row (children: <Widget>[
      Text('HI !',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.white),)
    ],)
    ),
    Positioned(
      bottom: 0,
...
Container(height: 30,),
    const Padding(
      ...
      child:Row(children:[
    Text("Brands",style: TextStyle(fontWeight: FontWeight.bold,fontSize:25 ),
    ),
     ] )
    ),
    Container(height: 20,),
       ...
       child: Column(
        children: [
          Container(
           ...
           Text(brands[i]["title"],style: const TextStyle(fontWeight: FontWeight.bold),),
        ],
       ),
     ) ;
      }
...
GridView.builder(
  ...
  shrinkWrap: true,
  gridDelegate: const
  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisExtent: 230),
  itemBuilder:(context ,i ){
return Card(
      child:Column(

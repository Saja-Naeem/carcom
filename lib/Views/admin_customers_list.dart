                 ...
                 return Card(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      title: const Text('Customer Name', // yara here we add Customer name from data base
                      style: TextStyle(
                        color: Colors.white, 
              ...
              return Card(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    title: const Text(
                      'Customer Name', // yara here we add Customer name from data base
                      style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                      ),

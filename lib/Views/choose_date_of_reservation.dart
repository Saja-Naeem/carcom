...
class DateDetermine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dateFromTextController = TextEditingController(text: DateFormat('dd MMM yyyy').format(DateTime.now()));
    final dateToTextController = TextEditingController(text: DateFormat('dd MMM yyyy').format(DateTime.now()));
          
    return Scaffold(
      appBar: AppBar(
        title: const Text('Date Determine',textAlign: TextAlign.center,),
        centerTitle: true,
      ),
      body: Container(
...
class CustomTextField extends StatelessWidget {
  ...
  try {
    ...
    if (parsedDate.day != day || parsedDate.year != year ||
